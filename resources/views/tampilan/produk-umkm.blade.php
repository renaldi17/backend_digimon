            ...
            <div class="flex flex-col md:flex-row gap-10">
                ...
                <div class="md:flex-1 md:w-2/3">
                    ...
                    <p class="text-base text-justify mb-4 leading-relaxed">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis mollitia maiores minima,
                        velit amet, veniam aliquam sapiente odit sequi deleniti vero? Ipsa nesciunt maxime, repellendus
                        fugit nulla accusamus ex sint doloribus libero unde voluptatum sit est quibusdam. Corrupti
                        quibusdam accusantium eos repudiandae, ratione expedita? Quasi ab porro molestiae doloremque
                        similique nam sequi unde eaque dignissimos? Voluptatum sequi corporis praesentium corrupti sunt
                        neque nam consectetur, quidem cumque, reprehenderit atque ullam fuga porro incidunt cum ad, vel
                        veritatis pariatur facere officia accusamus ut delectus repudiandae! Illum tempore id error
                        itaque natus dolor, magnam tenetur distinctio amet doloribus iusto omnis quae, ipsa quod!
                    </p>
                    <p class="text-base text-justify mb-4 leading-relaxed">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis mollitia maiores minima,
                        velit amet, veniam aliquam sapiente odit sequi deleniti vero? Ipsa nesciunt maxime, repellendus
