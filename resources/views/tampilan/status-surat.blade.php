                    ...
                    <div class="h-full bg-white p-6">
                        ...
                        >
                            <div class="flex w-full flex-col items-start">
                                <div
                                    class="mb-1items-start flex w-full md:mb-0 md:ml-0 md:items-center"
                                >
                                    <label
                                        for="nik"
                                        class="font block text-sm text-gray-700 md:text-base"
                                    >
                                        NIK
                                    </label>
                                    <input
                                ...
                                <div
                                    class="flex w-full flex-col items-start sm:flex-row sm:items-center"
                                >
                                    <label
                                        for="nama_lengkap"
                        ...
                        <div class="h-72 overflow-x-auto overflow-y-auto">
                            <table
                                id="dataSuratTable"
                                class="display mt-5 h-64 w-full overflow-hidden shadow-md"
                            >
                                <thead>
                                ...
                                <tbody class="min-h-[12rem]">
                                    @foreach ($dataSurat as $surat)
                                        <tr class="text-center">
                                            ...
                                            <td
                                                class="flex justify-center gap-2 border-b px-4 py-2 text-center"
                                            >
                                                <button
