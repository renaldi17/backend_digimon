...
<body>
    ...
    <main class="min-h-screen">
        <section class="min-[512px] relative h-screen max-h-[680px] pt-16 md:pt-32">
            <div class="relative z-10 mt-4 flex max-w-screen-lg flex-col gap-y-2 text-zinc-50 lg:container xl:pl-48">
                <div>
            ...
            <div class="container absolute left-0 right-0 top-80 z-10 max-w-screen-lg lg:top-[512px]">
        ...
        <section class="container mt-80 py-12 sm:mt-12 md:mt-6 lg:mt-52">
            <h2 class="scroll-m-20 pb-2 text-center text-3xl font-semibold tracking-tight first:mt-0">
        ...
        <section class="container space-y-8 py-12 md:space-y-16">
            ...
            <div class="mx-auto flex max-w-screen-lg">
                <div
                    ...
                    <div class="flex aspect-square items-center justify-center rounded-full">
                        <i class="fa-solid fa-user h-12 w-12 text-zinc-800"></i>
                    </div>
                    <div>
                ...
                <div
                    class="flex h-full w-full flex-col items-center justify-start gap-y-2 rounded-md px-2 py-4 text-center">
                    <div class="flex aspect-square items-center justify-center rounded-full">
                        <i class="fa-solid fa-users h-24 w-24 text-zinc-800"></i>
                    </div>
                    <div>
            ...
            <div>
                <div class="flex h-full w-full flex-row justify-center gap-x-2 md:gap-x-8">
                    <div class="flex aspect-square p-4">
                        <i class="fa-solid fa-chart-pie h-32 w-32 text-zinc-800"></i>
                    </div>
                    <div class="space-y-2">
                        <div>
                            <h6 class="text-lg font-semibold">
        ...
        <section class="container my-6 flex flex-col gap-x-12 gap-y-6 py-12 sm:flex-row sm:justify-center">
