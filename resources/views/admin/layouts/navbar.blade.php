<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    ...
    <a class="navbar-brand mt-1 ps-3" href="#">
        <img src="/assets/img/logo-ad.png" width="150px" alt="" />
    </a>
    <!-- Sidebar Toggle-->
    <button
        class="btn btn-link btn-sm order-lg-0 me-lg-0 order-1 me-4"
        id="sidebarToggle"
        href="#!"
    >
    ...
    <!-- Navbar-->
    <ul
        class="navbar-nav d-none d-md-inline-block form-inline me-md-3 my-md-0 my-2 me-0 ms-auto"
    >
                        ...
                        >
                            ...
                            >
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a
                                        class="nav-link"
                                        href="{{ route("potensi_desa.index") }}"
                                    >
                                        Potensi
                                    </a>
                                    <a
                                        class="nav-link"
                                        href="{{ route("produk_hukum.index") }}"
                                    >
                                        Produk Hukum
                                    </a>
                                </nav>
