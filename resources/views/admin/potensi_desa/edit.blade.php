    ...
    @endif
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <form id="save-form" action="{{ route('potensi_desa.update', $potensiDesa->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label for="nama">Nama</label>
                                <input type="text" name="nama" class="form-control" id="nama" value="{{ $potensiDesa->nama }}" required>
                            </div>
                                ...
                                <div class="col-lg-8">
                                    <div class="mb-3">
                                        ...
                                        @if ($potensiDesa->gambar)
                                            <img src="/storage/{{ $potensiDesa->gambar }}" width="150px" class="img-thumbnail mt-2" id="previewImage" style="max-width: 100%;">
                                        @else
                            ...
                            <div class="form-group mt-3">
                                ...
                                <input type="text" name="lokasi" class="form-control" id="lokasi" value="{{ $potensiDesa->lokasi }}" required>
                            </div>
                            <div class="form-group mt-3">
                                <label for="hari_buka">Hari Buka</label>
                                <input type="text" name="hari_buka" class="form-control" id="hari_buka" value="{{ $potensiDesa->hari_buka }}" required>
                            </div>
                            <div class="form-group mt-3">
                                <label for="hari_tutup">Hari Tutup</label>
                                <input type="text" name="hari_tutup" class="form-control" id="hari_tutup" value="{{ $potensiDesa->hari_tutup }}" required>
                            </div>
                            <div class="form-group mt-3">
                                <label for="buka">Buka</label>
                                <input type="time" name="buka" class="form-control" id="buka" value="{{ $potensiDesa->buka }}" required>
                            </div>
                            <div class="form-group mt-3">
                                <label for="tutup">Tutup</label>
                                <input type="time" name="tutup" class="form-control" id="tutup" value="{{ $potensiDesa->tutup }}" required>
                            </div>
