...
@section('content')
    <div class="container-fluid px-5">
        <h1 class="mb-4 mt-4">Tambah Potensi Desa</h1>
        <div class="row">
            <div class="col-lg-12">
                @if ($errors->any())
                    <div class="alert alert-danger">Cek lagi inputan anda</div>
                @endif

                <div class="card mb-4 shadow">
                    <div class="card-header py-3">
                        <form id="save-form" action="{{ route('potensi_desa.store') }}" method="POST"
