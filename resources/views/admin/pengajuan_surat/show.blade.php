                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table width="100%">
                            ...
                            <tr>
                                <th>Tanggal Balasan Terakhir</th>
                                <th>:</th>
                                <td>
                            ...
                            <tr>
                                <th>File Balasan</th>
                                <th>:</th>
                                <td><a href="/storage/{{ $pengajuanSurat->file_balasan }}" target="_blank"
                                        class="badge text-bg-info text-white"
                                        style="text-decoration: none; ">Preview/Download</a></td>
                            </tr>
            ...
            <div class="col-10 mb-3">
                <div class="row">
                    ...
                    <div class="col-2 offset-8">
                        <a href="{{ route('pengajuanSurat.updateStatus.index', $pengajuanSurat->id) }}"
                            class="btn btn-warning" style="color: #ffffff">
