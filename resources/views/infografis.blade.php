...
<html lang="en">
    ...
    <body>
        ...
        {{-- Perangkat Desa --}}
        <main
            class="my-36 flex w-full flex-col items-center gap-48 font-poppins"
        >
            <article class="flex w-full flex-col items-center gap-16">
                ...
                >
                    <iframe
                        ...
                        height="450"
                        style="border: 0; width: 80%; margin: 0 auto"
                        allowfullscreen=""
                        loading="lazy"
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div class="flex w-[80%] flex-row">
                                            <div
                                                class="h-[100%] shrink-0 bg-green-900"
                                                style="
                                                    width: {{ number_format(($pendudukCountsByGender->{'Laki-laki'} / $totalPenduduk) * 100, 1) . "%" }};
                                                "
                                            ></div>
                                    ...
                                    >
                                        ...
                                        <div class="flex w-[80%] flex-row">
                                            <div
                                                class="h-[100%] shrink-0 bg-green-900"
                                                style="
                                                    width: {{ number_format(($pendudukCountsByGender->{'Perempuan'} / $totalPenduduk) * 100, 1) . "%" }};
                                                "
                                            ></div>
                                            <p class="ml-[5%] self-center">
                                    ...
                                    >
                                        ...
                                        <div class="flex w-[80%] flex-row">
                                            <div
                                                class="h-[100%] shrink-0 bg-green-900"
                                                style="
                                                    width: {{ number_format(($pendudukCountsByEdu->{'SD'} / $totalPenduduk) * 100, 1) . "%" }};
                                                "
                                            ></div>
                                            <p class="ml-[5%] self-center">
                                    ...
                                    >
                                        ...
                                        <div class="flex w-[80%] flex-row">
                                            <div
                                                class="h-[100%] shrink-0 bg-green-900"
                                                style="
                                                    width: {{ number_format(($pendudukCountsByEdu->{'SMP'} / $totalPenduduk) * 100, 1) . "%" }};
                                                "
                                            ></div>
                                            <p class="ml-[5%] self-center">
                                    ...
                                    >
                                        ...
                                        <div class="flex w-[80%] flex-row">
                                            <div
                                                class="h-[100%] shrink-0 bg-green-900"
                                                style="
                                                    width: {{ number_format(($pendudukCountsByEdu->{'SMA'} / $totalPenduduk) * 100, 1) . "%" }};
                                                "
                                            ></div>
                                            <p class="ml-[5%] self-center">
                                    ...
                                    >
                                        ...
                                        <div class="flex w-[80%] flex-row">
                                            <div
                                                class="h-[100%] shrink-0 bg-green-900"
                                                style="
                                                    width: {{ number_format(($pendudukCountsByEdu->{'Diploma'} / $totalPenduduk) * 100, 1) . "%" }};
                                                "
                                            ></div>
                                            <p class="ml-[5%] self-center">
                                    ...
                                    >
                                        ...
                                        <div class="flex w-[80%] flex-row">
                                            <div
                                                class="h-[100%] shrink-0 bg-green-900"
                                                style="
                                                    width: {{ number_format(($pendudukCountsByEdu->{'S1'} / $totalPenduduk) * 100, 1) . "%" }};
                                                "
                                            ></div>
                                            <p class="ml-[5%] self-center">
                                    ...
                                    >
                                        ...
                                        <div class="flex w-[80%] flex-row">
                                            <div
                                                class="h-[100%] shrink-0 bg-green-900"
                                                style="
                                                    width: {{ number_format(($pendudukCountsByEdu->{'S2'} / $totalPenduduk) * 100, 1) . "%" }};
                                                "
                                            ></div>
                                            <p class="ml-[5%] self-center">
                                    ...
                                    >
                                        ...
                                        <div class="flex w-[80%] flex-row">
                                            <div
                                                class="h-[100%] shrink-0 bg-green-900"
                                                style="
                                                    width: {{ number_format(($pendudukCountsByEdu->{'S3'} / $totalPenduduk) * 100, 1) . "%" }};
                                                "
                                            ></div>
                                            <p class="ml-[5%] self-center">
                                    ...
                                    >
                                        ...
                                        <div class="flex w-[80%] flex-row">
                                            <div
                                                class="h-[100%] shrink-0 bg-green-900"
                                                style="
                                                    width: {{ number_format(($pendudukCountsByEdu->{'Putus Sekolah'} / $totalPenduduk) * 100, 1) . "%" }};
                                                "
                                            ></div>
                                            <p class="ml-[5%] self-center">
                                    ...
                                    >
                                        ...
                                        <div class="flex w-[80%] flex-row">
                                            <div
                                                class="h-[100%] shrink-0 bg-green-900"
                                                style="
                                                    width: {{ number_format(($pendudukCountsByJob->{'Aparatur Sipil Negara'} / $totalPenduduk) * 100, 1) . "%" }};
                                                "
                                            ></div>
                                            <p class="ml-[5%] self-center">
                                    ...
                                    >
                                        ...
                                        <div class="flex w-[80%] flex-row">
                                            <div
                                                class="h-[100%] shrink-0 bg-green-900"
                                                style="
                                                    width: {{ number_format(($pendudukCountsByJob->{'Pelajar/Mahasiswa'} / $totalPenduduk) * 100, 1) . "%" }};
                                                "
                                            ></div>
                                            <p class="ml-[5%] self-center">
                                    ...
                                    >
                                        ...
                                        <div class="flex w-[80%] flex-row">
                                            <div
                                                class="h-[100%] shrink-0 bg-green-900"
                                                style="
                                                    width: {{ number_format(($pendudukCountsByJob->{'Wiraswasta'} / $totalPenduduk) * 100, 1) . "%" }};
                                                "
                                            ></div>
                                            <p class="ml-[5%] self-center">
                                    ...
                                    >
                                        ...
                                        <div class="flex w-[80%] flex-row">
                                            <div
                                                class="h-[100%] shrink-0 bg-green-900"
                                                style="
                                                    width: {{ number_format(($pendudukCountsByJob->{'Tidak Bekerja'} / $totalPenduduk) * 100, 1) . "%" }};
                                                "
                                            ></div>
                                            <p class="ml-[5%] self-center">
                                    ...
                                    >
                                        ...
                                        <div class="flex w-[80%] flex-row">
                                            <div
                                                class="h-[100%] shrink-0 bg-green-900"
                                                style="
                                                    width: {{ number_format(($pendudukCountsByJob->{'Pengurus Rumah Tangga'} / $totalPenduduk) * 100, 1) . "%" }};
                                                "
                                            ></div>
                                            <p class="ml-[5%] self-center">
                                    ...
                                    >
                                        ...
                                        <div class="flex w-[80%] flex-row">
                                            <div
                                                class="h-[100%] shrink-0 bg-green-900"
                                                style="
                                                    width: {{ intval(($pendudukCountsByJob->{'Tenaga Medis'} / $totalPenduduk) * 100, 1) . "%" }};
                                                "
                                            ></div>
                                            <p class="ml-[5%] self-center">
                                    ...
                                    >
                                        ...
                                        <div class="flex w-[80%] flex-row">
                                            <div
                                                class="h-[100%] shrink-0 bg-green-900"
                                                style="
                                                    width: {{ intval(($pendudukCountsByJob->{'Tenaga Kesehatan'} / $totalPenduduk) * 100, 1) . "%" }};
                                                "
                                            ></div>
                                            <p class="ml-[5%] self-center">
                                    ...
                                    >
                                        ...
                                        <div class="flex w-[80%] flex-row">
                                            <div
                                                class="h-[100%] shrink-0 bg-green-900"
                                                style="
                                                    width: {{ number_format(($pendudukCountsByJob->{'Lainnya'} / $totalPenduduk) * 100, 1) . "%" }};
                                                "
                                            ></div>
                                            <p class="ml-[5%] self-center">
                                ...
                                >
                                    @foreach ($tampilSarana as $sarana)
                                        ...
                                        >
                                            ...
                                            <div class="flex w-[80%] flex-row">
                                                <div
                                                    class="h-[100%] w-[%] shrink-0 bg-green-900"
                                                    style="
                                                        width: {{ number_format(($sarana["jumlah"] / $totalSarana) * 100, 1) . "%" }};
                                                    "
                                                ></div>
                                                <p class="ml-[5%] self-center">
                                                    {{ $sarana["jumlah"] }}
