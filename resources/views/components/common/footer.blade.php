    ...
    <footer class="container min-h-48 bg-[#3B432C] py-6 text-zinc-50">
        <div class="flex w-full flex-col gap-x-12 gap-y-8 lg:flex-row">
            <div class="lg:basis-1/3">
                <h4
                    class="scroll-m-20 text-xl font-semibold tracking-tight text-[#FCE5AD]"
                >
                    TEGAL MANGGUNG
                </h4>
            ...
            <div class="lg:basis-1/3">
                ...
                <ul
                    class="list-none space-y-2 leading-7 text-muted [&:not(:first-child)]:mt-2"
                >
                    <li>
            ...
            <div class="lg:basis-1/3">
                ...
                <div
                    class="mt-4 flex items-center justify-between gap-x-2 sm:max-w-64"
                >
                    <a
